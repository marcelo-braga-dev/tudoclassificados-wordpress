...
function the_acadp_favourites_link( $post_id = 0 ) {
	if ( is_user_logged_in() ) {	
		...
		if ( in_array( $post_id, $favourites ) ) {
			echo '<a href="javascript:void(0)" class="acadp-favourites" data-post_id="' . $post_id . '"><i class="icon fas fa-heart text-danger" title="Remover dos Favoritos" data-placement="top" data-toggle="tooltip"></i></a>';
		} else {
			echo '<a href="javascript:void(0)" class="acadp-favourites" data-post_id="' . $post_id . '"><i class="text-danger bi bi-heart" title="Adicionar aos Favoritos" data-placement="top" data-toggle="tooltip"></i></a>';
		}	
	} else {	
		echo '<a href="javascript:void(0)" class="acadp-require-login"><i class="text-danger bi bi-heart" title="Adicionar aos Favoritos" data-placement="top" data-toggle="tooltip"></i></a>';		
	}	
}
