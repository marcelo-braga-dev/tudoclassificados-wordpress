...
<script src="/wp-functions/pages/anuncio_unico/imoveis/assets/js/frete.js?id=<?= uniqid() ?>"></script>

<?php
function bs4t_nova_pergunta_produtos()
{
?>
   <script src="/wp-functions/pages/anuncio_unico/imoveis/assets/js/nova_pergunta.js"></script>
   <script src="/wp-functions/pages/anuncio_unico/imoveis/assets/js/videos.js"></script>
<?php
}
