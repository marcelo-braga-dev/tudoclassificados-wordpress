...
<div class="acadp acadp-user acadp-manage-listings acadp-list-view">
	...
	<div class="row justify-content-end">
		<div class="col-md-6">
			<form action="<?php echo esc_url(acadp_get_manage_listings_page_link(true)); ?>" role="form">
				...
				<div class="form-row">
					<div class="col-md-8">
						...
						<input type="text" name="u" class="form-control" placeholder="Pesquisar anúncio..." value="<?php echo esc_attr($search_query); ?>" />
					</div>
	...
	?> <div class="card mb-3">
			<div class="row p-3">
				<div class="col-md-3">
					<a href="<?php the_permalink(); ?>"><img src="<?php the_acadp_listing_thumbnail($post_meta); ?>" class="rounded"> </a>
				</div>
				...
				<div class="col-md-3 text-right">
					...
					<div class="row">
						<div class="col-12">
							...
							<?php if ($can_edit) : ?>
								<a href="<?php echo esc_url(acadp_get_listing_edit_page_link($post->ID)); ?>" class="btn btn-success">
									<i class="bi bi-pencil-fill"></i>
								</a>
							<?php endif; ?>
							<a href="<?php echo esc_url(acadp_get_listing_delete_page_link($post->ID)); ?>" class="btn btn-danger" onclick="return confirm( '<?php esc_attr_e('Are you sure you want to delete this listing?', 'advanced-classifieds-and-directory-pro'); ?>' );">
