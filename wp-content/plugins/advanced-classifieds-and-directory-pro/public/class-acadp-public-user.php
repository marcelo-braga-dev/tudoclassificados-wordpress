...
class ACADP_Public_User {
	...
	public function __construct() {		
		...
		add_shortcode( "acadp_manage_listings_filiado", array( $this, "run_shortcode_manage_listings_filiado" ) );
	...
	// xXX Anuncios Filiados
	/**
	 * Process the shortcode [acadp_manage_listings_filiado].
	 *
	 * @since 1.0.0
	 */
	public function run_shortcode_manage_listings_filiado() {	
		if ( ! is_user_logged_in() ) {		
			return acadp_login_form();			
		}		
		...
		$shortcode = 'acadp_manage_listings_filiado';
