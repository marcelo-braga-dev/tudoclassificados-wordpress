            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php endif ?>
                        <? if (count($produtosBling['produtos']) && $_GET['marketplace_bling']) : ?>
                            <hr class="mb-1">
                            <div class="row">
                                            ...
                                            <?php foreach ($produtosBling['produtos'] as $var) :
                                                ...
                                                <tr>
                                                    <td scope="row" style="width: 2rem;">
                                                        <input type="hidden" name="token_bling" class="form-control" value="<?= $_GET['token_bling'] ?>">
                                                    ...
                                                    <td style="white-space: normal !important;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" step="0.01" class="form-control" name="produto[<?= $produto->id ?>][preco]" placeholder="0,00" aria-label="Preco" value="<?= number_format($produto->preco, 2, '.', ''); ?>" <?= $anuncioComImagens ? '' : 'disabled' ?>>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 align-self-end">
                                                                <div class="avatar-group d-block">
                                                                    <?php foreach ($produto->imagem as $imagem) : ?>
                                                                        <a class="avatar avatar rounded-circle" data-toggle="tooltip">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label>Largura</label>
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control" name="produto[<?= $produto->id ?>][largura]" placeholder="0,00" value="<?= $produto->larguraProduto; ?>" <?= $anuncioComImagens ? '' : 'disabled' ?>>
                                                            ...
                                                            <div class="col-md-3">
                                                                <label>Altura</label>
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control" name="produto[<?= $produto->id ?>][altura]" placeholder="0,00" value="<?= $produto->alturaProduto; ?>" <?= $anuncioComImagens ? '' : 'disabled' ?>>
                                                                    <div class="input-group-append">
                                                                        <small class="input-group-text">cm</small>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control" name="produto[<?= $produto->id ?>][profundidade]" placeholder="0,00" value="<?= $produto->profundidadeProduto; ?>" <?= $anuncioComImagens ? '' : 'disabled' ?>>
                                                                    <div class="input-group-append">
                                                                        <small class="input-group-text">cm</small>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <label>Peso</label>
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control" name="produto[<?= $produto->id ?>][peso]" placeholder="0,00" value="<?= number_format($produto->pesoBruto, 2, '.', ''); ?>" <?= $anuncioComImagens ? '' : 'disabled' ?>>
                                                                    <div class="input-group-append">
