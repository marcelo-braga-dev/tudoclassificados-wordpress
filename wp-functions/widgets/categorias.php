...
<div class="row m-2 m-md-0">
    <div class="col-12 card p-1 rounded mt-3">
        <div class="list-group list-group-flush">
            ...
            ?>
                    <a class="list-group-item list-group-item-action widget-categoria p-2 px-3" href="<?= esc_url($category_url) ?>" title="<?= esc_attr($title_attr) ?>">
            ...
            <a class="list-group-item list-group-item-action widget-categoria p-2 px-3" href="/lista-categorias/">
                <div class="d-inline" style="width: 0px;"><i aria-hidden="true" class="fas fa-layer-group mr-2"></i></div>
                Todas Categorias
            </a>
        </div>
    </div>
