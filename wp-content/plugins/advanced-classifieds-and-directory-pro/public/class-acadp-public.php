...
class ACADP_Public {
	...
	public function register_enqueue_styles() {
		...
		wp_register_style( ACADP_PLUGIN_NAME . '-magnific-popup', ACADP_PLUGIN_URL . 'public/css/magnific-popup.css', array(), '1.1.0', 'all' );
	...
	public function register_enqueue_scripts() {	
		...
		wp_register_script( ACADP_PLUGIN_NAME . '-magnific-popup', ACADP_PLUGIN_URL . 'public/js/jquery.magnific-popup.min.js', array( 'jquery' ), '1.1.0', true );
