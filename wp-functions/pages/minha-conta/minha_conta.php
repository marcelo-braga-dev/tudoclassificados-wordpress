        ...
        <div class="row">
            <div class="col-md-3 card pt-4 pb-md-9 mb-md-9">
                ...
                <div class="list-group navbar-nav" id="minhaLista" role="tablist" style="font-size: 13px;">
                    ...
                    <a class="text-main mb-2" id="#anuncios-marketplace-tab" data-toggle="list" href="#marketplace_anuncios" role="tab">
                        <div class="row nav-item">
                            <div class="col-2 text-right"></div>
                            <div class="col-10 pl-4">
                                <span class="text-sub-menu">Anúncios do Marketplace</span>
                            </div>
                        </div>
                    </a>

                    <a class="text-main mb-2 <?= $abaMenu == 'marketplace_bling' ? 'active' : '' ?>" id="bling-tabx" data-toggle="list" href="#marketplace_bling" role="tab">
                        <div class="row nav-item">
                            <div class="col-2 text-right">
                            </div>
                            <div class="col-10 pl-4 text-sub-menu">
                                Integrar com Bling
                            </div>
                        </div>
                    </a>

                    <a class="text-main mb-2" id="#marketplace-marketplace_mercadopago-tab" data-toggle="list" href="#marketplace_mercadopago" role="tab">
                        <div class="row nav-item">
                            <div class="col-2 text-right"></div>
                            <div class="col-10 pl-4">
                                <span class="text-sub-menu">Conta MercadoPago</span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-divider pb-2"></div> -->
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="comentarios" role="tabpanel">
                        <?php include 'partials/comentarios.php' ?>
                    </div>

                    <!-- Pagamentos -->
                    <div class="tab-pane fade" id="pagamentos" role="tabpanel">
                        <?php include 'partials/pagamentos.php' ?>
                    </div>

                    <!-- Perfil -->
                    <div class="tab-pane fade" id="editar-perfil" role="tabpanel">
                        <?php include 'partials/editar_perfil.php' ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    var maxPremiumGeral = '<?= bs4t_user_is_premium('geral') ?>';
    var maxPremiumImovel = '<?= bs4t_user_is_premium('imoveis') ?>';
    var qtdImovelAtivo = '<?= $qtdImovelAtivo ?>';
    var qtdGeralAtivo = '<?= $qtdGeralAtivo ?>';

    var abaMeusAnuncios = <?= get_query_var('paged') ?>;
    var abaIntegracaoMinhaConta = '<?= $_POST['buscar-ingaia'] . $_POST['integrar_ingaia'] ?>';
    var abaIntegracaoBling = '<?= $_GET['page_bling'] . $_POST['api-key-bling'] ?>';
</script>
...
{   ?>
    <script src="/wp-functions/pages/minha-conta/assets/js/main.js?id=<?= uniqid() ?>"></script>
    <script src="/wp-functions/pages/minha-conta/assets/js/abas.js?id=<?= uniqid() ?>"></script>
<?php
}
