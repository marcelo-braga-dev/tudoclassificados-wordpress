	...
	<div class="row mt-3">
		<div class="col-12">
			<div class="row justify-content-end text-end mb-2">
				...
				<div class="col-auto">
					<a href="/minha-conta">
						<img height="25px" src="/wp-functions/imagens/logo-bling.png" style="height: 25px;">
					</a>
				</div>
				<div class="col-auto">
					<a href="/minha-conta">
						<img src="/wp-functions/imagens/logo-inGaia.png" style="height: 25px;">
					</a>
				</div>
			</div>
		</div>
...
{
?>
	<script src="/wp-functions/assets/js/currency.js"></script>
	<script src="/wp-functions/assets/js/cidade-estado-select/main.js?id=<?= uniqid() ?>"></script>
	<script src="/wp-functions/pages/novo_anuncio/assets/js/principal.js?id=<?= uniqid() ?>"></script>
<?php
}
