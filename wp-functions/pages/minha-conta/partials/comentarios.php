<?php
global $wpdb;
include_once ABSPATH . 'wp-functions/pages/minha-conta/assets/php/db_comentarios.php';
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="alerta-comentarios" class="m-3 <?php if ($qtdComentarios > 0) echo 'd-none'; ?>"><span>Não há comentários para responder.</span></div>
                            </div>
                        </div>
                    </div>
                </div>
...
{
?>
    <script src="/wp-functions/pages/minha-conta/assets/js/comentarios.js?id=<?= uniqid() ?>"></script>
<?php
}
