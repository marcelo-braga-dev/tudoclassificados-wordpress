      ...
      <form action="<?php echo esc_url(acadp_get_listing_form_page_link()); ?>" method="post" id="acadp-post-form" class="form-vertical" role="form">
            ...
            <?php if ($can_add_price) : ?>
                  ...
                  <div class="panel panel-default bg-white">
                        <div class="panel-heading bg-white">Preço
            ...
            <?php endif; ?>
            <?php include ABSPATH . 'wp-functions/assets/js/currency.php'; ?>
            ...
            <!-- Complete listing -->
            <div class="panel panel-default">
                  <div class="panel-heading bg-white">Completar Anúncio
                  ...
                  <div class="panel-body bg-white">
                        ...
                        <?php if ($has_draft) { ?>
                              <input type="submit" name="action" class="btn btn-primary pull-right acadp-listing-form-submit-btn" value="<?php esc_html_e('Próximo', 'advanced-classifieds-and-directory-pro'); ?>" />
                        <?php } else { ?>
